...
if __name__ == "__main__":
    # Test logic tổng hợp
    tests = [
        "App ncc lag vcl, z fold 6 dùng k dc.",
        "chuyển tien bi treo cứ hen 2 ngay roi", # Test lỗi dấu
        "nguoiaf ta bảo 0tp mã mã xác thực", # Test lỗi lặp + typo
        "phiền dcd, môm bị lỗi rồi" # Test phrase fix + teencode mới
    ]
    for t in tests:
        print(f"In:  {t}\nOut: {clean_text(t)}\n")
